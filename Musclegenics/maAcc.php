...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="maAcc/maAcc.css">
    <meta charset="utf-8">
    <title>Martial Arts Accessories</title>
    <style media="screen">
      .btn {
        width: 35%;
        color: black;
  ...
  <body>
      ...
      <h1 align="center" style="font-size: 80px;">Making the world perfect</h1>
      </br></br>
      <div class="flexbox">
        <div class="row1">
          <div class="col1">
            <label>Mits R199.00</label></br></br>
            <img src="maAcc/mits.jpg">
          </br></br></br>
          <button class="btn" style="font-size: 20px;"><b>Add to cart</b></button>
          </div>
          <div class="col1">
            <label>Title mits R499.00</label></br></br>
            <img src="maAcc/titleMits.jpg">
          </br></br></br></br></br></br></br>
          <button class="btn" style="font-size: 20px;"><b>Add to cart</b></button>
          </div>
          <div class="col1">
            <label>Title wraps R99.99</label></br></br>
            <img src="maAcc/titleWraps.jpg">
          </br></br></br></br></br>
          <button class="btn" style="font-size: 20px;"><b>Add to cart</b></button>
          </div>
        </div>
