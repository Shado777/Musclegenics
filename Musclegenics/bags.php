...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="bags/bag.css">
    <meta charset="utf-8">
    <title>Bags</title>
    <style media="screen">
      .btn {
  ...
  <body>
      ...
      <h1 align="center" style="font-size: 80px;">Bags for unrelenting power</h1>
        <div class="flexbox">
          <div class="row1">
            <div class="col1">
              <label>Venum punching bag R1100.00</label></br></br>
              <img src="bags/venum.jpg">
            </br></br></br></br>
            <button class="btn" style="font-size: 20px;"><b>Add to cart</b></button>
            </div>
            <div class="col1">
              <label>Title punching bag R899.00</label></br></br>
              <img src="bags/titleBag.jpg">
            </br></br></br></br>
            <button class="btn" style="font-size: 20px;"><b>Add to cart</b></button>
            </div>
            <div class="col1">
              <label>Title Kick shield R699.00</label></br></br>
              <img src="bags/titleKickshield.jpg">
            </br></br></br></br>
            <button class="btn" style="font-size: 20px;"><b>Add to cart</b></button>
            </div>
          </div>
