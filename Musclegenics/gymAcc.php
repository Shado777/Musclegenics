...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="gymAcc/gymAcc.css">
    <meta charset="utf-8">
  ...
  <body>
      ...
      <h1 align="center" style="font-size: 80px;">Gym Accessories for an extra finesse</h1>
      <div class="flexBox">
        <div class="row1">
          <div class="col1">
            <label>Trojan fitness gym gloves R300.00</label></br></br>
            <img src="gymAcc/fitGloves.jpg">
          </br></br></br></br></br></br></br></br>
          <button class="btn" style="font-size: 20px;"><b>Add to cart</b></button>
          </div>
          <div class="col1">
            <label>Universal gym mat R250.00</label></br></br>
            <img src="gymAcc/gymMat.jpg">
          </br></br></br></br>
          <button class="btn" style="font-size: 20px;"><b>Add to cart</b></button>
          </div>
          <div class="col1">
            <label>Trojan alluminium jump rope R200.00</label></br></br>
            <img src="gymAcc/jumpRope.jpg">
          </br></br></br></br>
          <button class="btn" style="font-size: 20px;"><b>Add to cart</b></button>
          </div>
        </div>
